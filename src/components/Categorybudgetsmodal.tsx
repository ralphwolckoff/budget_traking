  ...
  return (
    <ModalOverlay onClose={onClose}>
      <ModalBox maxWidth="500px">
        ...
        {/* Résumé budget */}
        <div className="bg-surface/50 border border-border rounded-xl py-3 px-3.5 mb-4">
          ...
          <div className="h-2.5 bg-surface rounded-full overflow-hidden my-2">
            <div
        ...
        <div className="flex flex-col gap-2 mb-4">
          {CATEGORIES.map((cat) => {
            ...
            return (
              <div
                key={cat.id}
                className="py-2.5 px-3 rounded-xl border border-border bg-surface/40"
              >
