    ...
    <div className="flex flex-col gap-2.5">
      {top.map((e, i) => {
        ...
        return (
          <div
            key={e.id}
            className="flex items-start gap-3 bg-surface rounded-xl py-3.5 px-4 transition-colors hover:bg-surface-soft"
          >
        ...
        {sorted.map((exp) => {
          ...
          return (
            <div
              ...
              className="flex items-center gap-3 bg-surface rounded-xl p-4 cursor-pointer transition-all hover:translate-x-1 hover:bg-surface-soft"
            >
              <div className="flex-1 min-w-0">
      ...
      <div className="flex gap-2 mb-5">
        {[
          ...
          <button
            ...
            className={`py-2 px-[18px] rounded-lg text-[0.88rem] font-semibold cursor-pointer transition-all
              ${subtab === t.id ? "bg-primary text-white" : "bg-surface-soft text-text-muted hover:text-text"}`}
          >
            {t.label}
          </button>
        ))}
