...
import type { AppData, Investment, InvestmentType } from "../../lib/types";
...
function InvestmentCard({
  ...
  return (
    <div
      onClick={onClick}
      className="bg-surface-soft rounded-2xl p-4 cursor-pointer transition-all hover:bg-surface hover:-translate-y-0.5 flex flex-col gap-3"
    >
      <div className="flex items-center gap-3">
        <span className="w-10 h-10 rounded-lg bg-primary/15 flex items-center justify-center text-xl flex-shrink-0">
          {ti.icon}
        </span>
